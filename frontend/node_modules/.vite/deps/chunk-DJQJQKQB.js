    ...
    EnvDetectorSync2.prototype._parseResourceAttributes = function(rawEnvAttributes) {
      ...
      try {
        for (var rawAttributes_1 = __values4(rawAttributes), rawAttributes_1_1 = rawAttributes_1.next(); !rawAttributes_1_1.done; rawAttributes_1_1 = rawAttributes_1.next()) {
          ...
          var _b = __read6(keyValuePair, 2), key = _b[0], value = _b[1];
          key = key.trim();
        ...
        try {
          if (rawAttributes_1_1 && !rawAttributes_1_1.done && (_a2 = rawAttributes_1.return)) _a2.call(rawAttributes_1);
        } finally {
          if (e_1) throw e_1.error;
        }
      }
  ...
  function() {
    function BasicTracerProvider2(config) {
      ...
      if ((_b = config.spanProcessors) === null || _b === void 0 ? void 0 : _b.length) {
        this._registeredSpanProcessors = __spreadArray3([], __read7(config.spanProcessors), false);
...
var InMemorySpanExporter = (
  ...
  function() {
    ...
    InMemorySpanExporter2.prototype.export = function(spans, resultCallback) {
      ...
      (_a2 = this._finishedSpans).push.apply(_a2, __spreadArray4([], __read8(spans), false));
      setTimeout(function() {
...
export {
  ...
  AlwaysOffSampler2 as AlwaysOffSampler,
  AlwaysOnSampler2 as AlwaysOnSampler,
  ParentBasedSampler2 as ParentBasedSampler,
  TraceIdRatioBasedSampler2 as TraceIdRatioBasedSampler,
  BatchSpanProcessor,
  RandomIdGenerator2 as RandomIdGenerator,
  Tracer,
  NoopSpanProcessor,
  ForceFlushState,
  BasicTracerProvider,
...
//# sourceMappingURL=chunk-DJQJQKQB.js.map
